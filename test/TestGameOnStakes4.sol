...
contract TestGamesOnStakes4 {
    ...
    function testWinnerWithdrawal() public {
        ...
        uint32 gameIdx = gamesInstance.createGame(hash, "Sachin").value(0.01 ether);
        gamesInstance.acceptGame(gameIdx, 234, "Sanchay").value(0.01 ether);
    ...
    function testDrawWithdrawal() public {
        ...
        bytes32 hash = gamesInstance.saltedHash(100, "my salt goes here");
        uint32 gameIdx = gamesInstance.createGame.value(hash, "Sachin")(0.01 ether);
        gamesInstance.acceptGame.value(gameIdx, 234, "Sanchay")(0.01 ether);
        gamesInstance.confirmGame(gameIdx, 100, "my salt goes here");
